      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <form action="" method="POST" >
            ...
            <div class="row">
              <div class="col-lg-6">
                <input type="hidden" class="form-control" id="mothFullname" name="moth_fullname" placeholder="Mother's Fullname">
              </div>
              <div class="col-lg-6">
                <input type="hidden" maxlength="11" id="mothContact" minlength="11" name="moth_contact" class="form-control" placeholder="Mother's Contact Number">
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                <input type="hidden" class="form-control" id="fathFullname" name="fath_fullname" placeholder="Father's Fullname">
              </div>
              <div class="col-lg-6">
                <input type="hidden" maxlength="11" id="fathContact" minlength="11" name="fath_contact" class="form-control" placeholder="Father's Contact Number">
              </div>
            </div><hr>
            <h5> Class Details </h5>
            <div class="row">
              <div class="col-lg-6">
                <input type="hidden" class="form-control" name="glevel" id="glevelz">
                <input type="text" disabled class="form-control" id="glevelDesc" placeholder="Grade Level">
              </div>
              <div class="col-lg-6">
                <input type="hidden" class="form-control" name="secid" id="secData">
                <input type="text" disabled class="form-control" id="secDataDesc" placeholder="Section">
              </div>
            </div><hr><br>
            <div class="row">
