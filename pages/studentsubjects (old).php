  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> <a href="?gkey=<?= $subdesc['gradeid'] ?>&seckey=<?= $subdesc['sectionid'] ?>&subkey=<?= $subdesc['subjectid'] ?>"> View Modules </a> </span>
                <span class="info-box-number"> <a href="?gkey=<?= $subdesc['gradeid'] ?>&seckey=<?= $subdesc['sectionid'] ?>&quizkey=<?= $subdesc['subjectid'] ?>"> View Quizzes </a> </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="row">
          <div class="col-md-12">
            <h5 class="alert alert-success"> <?= $value['description'] ?> Modules </h5>
          <?php
        ...
        <h5 class="alert alert-success"> Upload Assignment Module </h5>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="custom-file">
                <input type="file" required class="custom-file-input" name="file" id="exampleInputFile">
              ...
              if($checkDuplexSubmision->num_rows <= 0){
                ...
                if(move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)){
                  ...
                  if($insert == true){
                    ...
                    echo '<script>alert("Quiz Answer File Uploaded")</script>';
                ...
                echo '<script>alert("Oops! It seems like you already uploaded your answer. Please message or contact your teacher If you need some changes. Thank you.")</script>';
        ...
        <div class="row">
          <div class="col-md-12">
            <h5 class="alert alert-success"> <?= $value['description'] ?> Quizzes </h5>
          <?php
          $gradeid = $conn->real_escape_string($_GET['gkey']);
          $subId = $conn->real_escape_string($_GET['quizkey']);
          $seckey = $conn->real_escape_string($_GET['seckey']);
            ...
            <div class="col-lg-3 col-sm-12 mods">
              ...
              <div class="small-box bg-info">
                ...
                <a href="?gkey=<?= $gradeid ?>&seckey=<?= $seckey ?>&quizkey=<?= $subId ?>&qId=<?= $modesc['quizzId'] ?>&#qres" class="small-box-footer">
                  Upload Answer File <i class="fas fa-upload"></i>
                </a>
              </div>
            </div>
          <?php
        ...
        ?>
          <h5 id="qres" class="alert alert-success"> Upload Quiz Response for <i class="text-yellow"> <?= $qnamez ?> </i> </h5>
          <form action="" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-lg-6">
