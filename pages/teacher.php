  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4 class="m-0 text-dark">Advisory Section's</h4>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> <a href="subjects.php?subkey=<?= $classData['gradeid'] ?>&seckey=<?= $classData['sectionid'] ?>"> <i class ="fas fa-book"></i> Subjects </a> </span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
